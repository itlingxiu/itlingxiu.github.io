...
const resourceSections: ResourceSection[] = [
  {
    ...
    tagColor: '#ef4444',
    items: [
      { icon: <ReadOutlined />, title: '小满go开发教程', desc: 'Go 基础入门到开发完整教程', url: 'https://go-docs.pages.dev/posts/', color: '#ef4444' },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: <ApiOutlined />, title: 'TooBox也盒', desc: '定制化开发工具及 API 调用大模型工具箱', url: 'https://www.toobox.love/#/', color: '#8b5cf6' },
