...
const tagPosts = computed(() => {
  return posts.filter(post => 
    post.frontmatter.tags && post.frontmatter.tags.includes('博客')
...
<template>
  <div class="tag-container">
    <div class="tag-header">
      <h1 class="tag-title">#博客</h1>
      <p class="tag-description">包含"博客"标签的所有文章</p>
      <div class="tag-stats">
