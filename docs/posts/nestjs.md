...
layout: page
title: Nest.js 相关文章
description: 探索 Nest.js 企业级后端框架
---
...
<template>
  <div class="tech-posts-container">
    <div class="page-header">
      ...
      <h1 class="page-title">Nest.js 文章</h1>
      <p class="page-description">探索 Nest.js 企业级后端框架，包括依赖注入、模块化架构等</p>
      <div class="posts-count">
        共 {{ nestjsPosts.length }} 篇文章
      </div>
    </div>
    ...
    <div v-else class="empty-state">
      ...
      <div class="empty-text">暂无 Nest.js 相关文章</div>
...
.page-title {
  ...
  margin-bottom: 1rem;
  background: linear-gradient(135deg, #e0234e, #b91831);
